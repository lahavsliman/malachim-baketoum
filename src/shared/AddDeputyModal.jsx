    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4"
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-lg max-h-[92vh] overflow-y-auto" dir="rtl">
        <div className="flex items-center justify-between mb-5">
          <h3 className="font-bold text-gray-900 text-lg flex items-center gap-2"><Plus size={18} /> הוספת סגן ראש סניף</h3>
          {!saving && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            <button type="button" onClick={onClose} disabled={saving}
              className="flex-1 bg-gray-100 hover:bg-gray-200 disabled:opacity-40 text-gray-800 py-2.5 rounded-xl transition text-sm">ביטול</button>
