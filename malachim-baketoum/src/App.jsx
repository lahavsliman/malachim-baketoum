...
function NotificationBanner({ onApprove, onDismiss }) {
  return (
    <div className="fixed bottom-4 right-4 left-4 sm:left-auto sm:w-80 bg-gray-800 border border-gray-700 rounded-2xl p-4 shadow-2xl z-40 flex flex-col gap-3" dir="rtl">
      ...
      <div className="flex gap-2">
        <button onClick={onDismiss}
          className="flex-1 bg-gray-700 hover:bg-gray-600 text-gray-300 py-2 rounded-xl text-sm transition">
          לא עכשיו
        </button>
