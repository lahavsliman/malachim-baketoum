    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 max-w-md w-full shadow-2xl">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-gray-100 mt-3">הגרלת לילות</h2>
        ...
        {!winner && !spinning && (
          <div className="text-center">
            {tickets.length === 0 ? (
              <p className="text-gray-400 mb-4">אין מתנדבים זכאים להגרלה החודש</p>
            ) : (
        ...
        {winner && (
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm mb-2">זוכה בהגרלת לילות!</p>
            {saved && (
            ...
            <button
              onClick={onClose}
              className="w-full bg-gray-800 hover:bg-gray-700 text-gray-200 py-2.5 rounded-xl transition mt-2"
            >
              סגור
            </button>
          </div>
