...
export default function InstallPrompt() {
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="bg-gray-900 border border-orange-500/40 rounded-2xl shadow-2xl p-4 max-w-sm w-full">

        {/* Header row */}
        <div className="flex items-start gap-3">
          <span className="text-2xl shrink-0">📱</span>
          <div className="flex-1 min-w-0">
            <p className="font-bold text-gray-100 text-sm">התקן את האפליקציה</p>
            <p className="text-orange-400 text-xs font-medium">מלאכים בכתום</p>
          </div>
          <button
            onClick={handleDismiss}
            className="text-gray-500 hover:text-gray-300 transition text-lg leading-none shrink-0 p-1"
            aria-label="סגור"
          >
            ✕
          </button>
          ...
          <div className="mt-2">
            ...
            <ol className="space-y-1 text-xs text-gray-300">
              <li className="flex items-center gap-2">
                ...
                לחץ על
                <span className="inline-flex items-center gap-0.5 bg-gray-800 border border-gray-700 rounded px-1.5 py-0.5 text-gray-200">
                  Share
              ...
              <li className="flex items-center gap-2">
                ...
                בחר
                <span className="bg-gray-800 border border-gray-700 rounded px-1.5 py-0.5 text-gray-200 whitespace-nowrap">
                  Add to Home Screen
                </span>
              </li>
              <li className="flex items-center gap-2">
            ...
            <button
              onClick={handleDismiss}
              className="mt-3 w-full bg-gray-800 hover:bg-gray-700 text-gray-300 py-2 rounded-xl text-sm transition"
            >
              הבנתי
            </button>
          </div>
